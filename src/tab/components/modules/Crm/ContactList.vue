...
export default {
    ...
    computed: {
        ...
        ...mapState({
            fields: state => state.contactFields.items,
    ...
    async mounted() {
       ...
       this.setBreadcrumb(['CRM', 'Контакты', 'Список']);
    },
    ...
    methods: {
        ...
        async loadEntries() {
            ...
            this.totalPages = Math.ceil(collection.total / Contact.PAGE_SIZE);
        },
